...
PlayerRdy:  lda #$09                  ;set routine to be executed by game engine next frame
            sta GameEngineSubroutine
...
PlayerAutoRun:
			 ...
			 and #A_Button
             ora #$41    ;check master timer control
             jmp AutoControlPlayer
...
JumpSwimSub:
          ...
          nop;lda A_B_Buttons
          nop;and #A_Button              ;check to see if A button is being pressed
          nop;and PreviousA_B_Buttons    ;and was pressed in previous frame
          nop;bne ProcSwim               ;if so, branch elsewhere
...
CheckForJumping:
        ...
        and #A_Button
        nop;beq NoJump                ;if not, branch to something else
        nop;and PreviousA_B_Buttons   ;if button not pressed in previous frame, branch
        bne ProcJumping
...
RunGameTimer:
           ...
           lda GameEngineSubroutine
           cmp #$09                   ;if routine number less than eight running,
